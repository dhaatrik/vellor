...
import { PrivacyPolicyModal } from './marketing-sections/PrivacyPolicyModal';
import { FriendlyTutorAdviceModal } from './marketing-sections/FriendlyTutorAdviceModal';
import { TermsOfServiceModal } from './marketing-sections/TermsOfServiceModal';
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-primary text-gray-900 dark:text-gray-100 overflow-x-hidden font-sans custom-scrollbar">
      ...
      <AnimatePresence>
        ...
        <FriendlyTutorAdviceModal isOpen={isAdviceOpen} onClose={() => setIsAdviceOpen(false)} />
